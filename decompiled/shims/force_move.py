...
# File: force_move.pyc (Python 3.9)
...
class ForceMove:
    ...
    def __init__(self, config):
        ...
        if config.getboolean('enable_force_move', False):
            ...
            gcode.register_command('SET_KINEMATIC_POSITION', self.cmd_SET_KINEMATIC_POSITION, desc=self.cmd_SET_KINEMATIC_POSITION_help)
