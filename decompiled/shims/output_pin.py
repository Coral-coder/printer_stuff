...
class PrinterOutputPin:
    ...
    def __init__(self, config):
        ...
        if self.is_pwm:
            ...
            cycle_time = config.getfloat('cycle_time', 0.1, above=0, maxval=MAX_SCHEDULE_TIME)
        ...
        if static_value is not None:
            ...
            max_mcu_duration = config.getfloat('maximum_mcu_duration', 0, minval=0.5, maxval=MAX_SCHEDULE_TIME)
