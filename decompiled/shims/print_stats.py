...
# File: print_stats.pyc (Python 3.9)
...
class PrintStats:
    ...
    def __init__(self, config):
        ...
        self.gcode.register_command('SET_PRINT_STATS_INFO', self.cmd_SET_PRINT_STATS_INFO, desc=self.cmd_SET_PRINT_STATS_INFO_help)
        self.power_loss = 0
    ...
    def cmd_SET_PRINT_STATS_INFO(self, gcmd):
        ...
        if self.info_total_layer is not None and current_layer is not None and current_layer != self.info_current_layer:
