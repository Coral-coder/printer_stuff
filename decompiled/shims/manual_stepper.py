...
# File: manual_stepper.pyc (Python 3.9)
...
class ManualStepper:
    ...
    def __init__(self, config):
        ...
        gcode.register_mux_command('MANUAL_STEPPER', 'STEPPER', stepper_name, self.cmd_MANUAL_STEPPER, desc=self.cmd_MANUAL_STEPPER_help)
    ...
    def do_homing_move(self, movepos, speed, accel, triggered, check_trigger):
        if not self.can_home:
            raise self.printer.command_error('{"code":"key198", "msg": "No endstop for this manual stepper", "values": []}')
