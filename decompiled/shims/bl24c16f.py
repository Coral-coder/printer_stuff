...
# File: bl24c16f.pyc (Python 3.9)

import logging
import struct
from . import bus
BL24C16F_CHIP_ADDR_0 = 80
BL24C16F_CHIP_ADDR_1 = 81
BL24C16F_CHIP_ADDR_2 = 82
BL24C16F_CHIP_ADDR_3 = 83
BL24C16F_CHIP_ADDR_4 = 84
BL24C16F_CHIP_ADDR_5 = 85
BL24C16F_CHIP_ADDR_6 = 86
BL24C16F_CHIP_ADDR_7 = 87
...
class EEPROMCommandHelper:
    ...
    def register_commands(self, name):
        ...
        gcode.register_mux_command('EEPROM_DEBUG_READ', 'CHIP', name, self.cmd_EEPROM_DEBUG_READ, desc=self.cmd_EEPROM_DEBUG_READ_help)
        gcode.register_mux_command('EEPROM_DEBUG_WRITE_BYTE', 'CHIP', name, self.cmd_EEPROM_DEBUG_WRITE_BYTE, desc=self.cmd_EEPROM_DEBUG_WRITE_BYTE_help)
        gcode.register_mux_command('EEPROM_DEBUG_WRITE_INT', 'CHIP', name, self.cmd_EEPROM_DEBUG_WRITE_INT, desc=self.cmd_EEPROM_DEBUG_WRITE_INT_help)
        gcode.register_mux_command('EEPROM_DEBUG_WRITE_FLOAT', 'CHIP', name, self.cmd_EEPROM_DEBUG_WRITE_FLOAT, desc=self.cmd_EEPROM_DEBUG_WRITE_FLOAT_help)
        gcode.register_mux_command('EEPROM_READ', 'CHIP', name, self.cmd_EEPROM_READ, desc=self.cmd_EEPROM_READ_help)
        gcode.register_mux_command('EEPROM_WRITE_BYTE', 'CHIP', name, self.cmd_EEPROM_WRITE_BYTE, desc=self.cmd_EEPROM_WRITE_BYTE_help)
        gcode.register_mux_command('EEPROM_WRITE_INT', 'CHIP', name, self.cmd_EEPROM_WRITE_INT, desc=self.cmd_EEPROM_WRITE_INT_help)
        gcode.register_mux_command('EEPROM_WRITE_FLOAT', 'CHIP', name, self.cmd_EEPROM_WRITE_FLOAT, desc=self.cmd_EEPROM_WRITE_FLOAT_help)
        gcode.register_mux_command('EEPROM_IS_FIRST_USED', 'CHIP', name, self.cmd_EEPROM_IS_FIRST_USED)
        gcode.register_mux_command('EEPROM_POS', 'CHIP', name, self.cmd_EEPROM_POS)
        gcode.register_mux_command('EEPROM_PRINTER_INFO', 'CHIP', name, self.cmd_EEPROM_PRINTER_INFO)
    ...
    def cmd_EEPROM_DEBUG_WRITE_INT(self, gcmd):
        ...
        vals += [
            ...
            val >> 16 & 255,
            val >> 24 & 255]
        gcmd.respond_info('EEPROM_DEBUG_WRITE_INT : ADDR[0x%x] = 0x%02x 0x%02x 0x%02x 0x%02x' % (addr, vals[0], vals[1], vals[2], vals[3]))
    ...
    def cmd_EEPROM_DEBUG_WRITE_FLOAT(self, gcmd):
        ...
        vals += [
            ...
            data >> 16 & 255,
            data >> 24 & 255]
        gcmd.respond_info('EEPROM_DEBUG_WRITE_FLOAT : ADDR[0x%x] = 0x%02x 0x%02x 0x%02x 0x%02x' % (addr, vals[0], vals[1], vals[2], vals[3]))
        self.chip.write_reg(addr, vals)
...
class BL24C16F:
    ...
    def __init__(self, config):
        ...
        self.i2c0 = bus.MCU_I2C_from_config(config, default_addr=BL24C16F_CHIP_ADDR_0, default_speed=400000)
        self.i2c1 = bus.MCU_I2C_from_config(config, default_addr=BL24C16F_CHIP_ADDR_1, default_speed=400000)
        self.i2c2 = bus.MCU_I2C_from_config(config, default_addr=BL24C16F_CHIP_ADDR_2, default_speed=400000)
        self.i2c3 = bus.MCU_I2C_from_config(config, default_addr=BL24C16F_CHIP_ADDR_3, default_speed=400000)
        self.i2c4 = bus.MCU_I2C_from_config(config, default_addr=BL24C16F_CHIP_ADDR_4, default_speed=400000)
        self.i2c5 = bus.MCU_I2C_from_config(config, default_addr=BL24C16F_CHIP_ADDR_5, default_speed=400000)
        self.i2c6 = bus.MCU_I2C_from_config(config, default_addr=BL24C16F_CHIP_ADDR_6, default_speed=400000)
        self.i2c7 = bus.MCU_I2C_from_config(config, default_addr=BL24C16F_CHIP_ADDR_7, default_speed=400000)
