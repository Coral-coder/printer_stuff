...
#     decompiled/_disasm/heater_bed.txt
# =====================================================================

# Source Generated with Decompyle++
# File: heater_bed.pyc (Python 3.9)
...
class PrinterHeaterBed:
    ...
    def __init__(self, config):
        ...
        self.pid = {
            'Kp': [
                config.getfloat('pid_220_kp', 18.578),
                config.getfloat('pid_110_kp', 52.98)],
            'Ki': [
                config.getfloat('pid_220_ki', 0.314),
                config.getfloat('pid_110_ki', 0.849)],
            'Kd': [
                config.getfloat('pid_220_kd', 274.489),
