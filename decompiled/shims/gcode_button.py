...
# File: gcode_button.pyc (Python 3.9)
...
class GCodeButton:
    ...
    def __init__(self, config):
        ...
        if config.get('analog_range', None) is None:
            ...
            pullup = config.getfloat('analog_pullup_resistor', 4.7e+03, above=0.0)
        ...
        self.gcode.register_mux_command('QUERY_BUTTON', 'BUTTON', self.name, self.cmd_QUERY_BUTTON, desc=self.cmd_QUERY_BUTTON_help)
