    ...
    def cmd_RESPOND(self, gcmd):
        ...
        if respond_type != None:
            ...
            if respond_type in respond_types:
                ...
                raise gcmd.error('{"code": "key309", "msg": "RESPOND TYPE \'%s\' is invalid. Must be one of \'echo\', \'command\', or \'error\'", "values":["%s"]}' % (respond_type, respond_type))
