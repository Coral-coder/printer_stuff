...
class Heater:
    ...
    def stats(self, eventtime):
        ...
        is_active = target_temp or last_temp > 5e+01
...
class ControlPID:
    ...
    def check_busy(self, eventtime, smoothed_temp, target_temp):
        ...
        return abs(temp_diff) > self.max_delta or abs(self.prev_temp_deriv) > PID_SETTLE_SLOPE
