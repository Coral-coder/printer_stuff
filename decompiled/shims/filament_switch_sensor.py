...
# File: filament_switch_sensor.pyc (Python 3.9)
...
class RunoutHelper:
    ...
    def _runout_event_handler(self, eventtime):
        ...
        if self.printer.lookup_object('box', None) is None or self.printer.lookup_object('box').box_action.box_state.Tn_data['enable'] == 0:
            self.gcode._respond_warning('!{"code":"key358", "msg":"filament switch sensor runout", "values": []}')
...
class SwitchSensor:
    ...
    def __init__(self, config):
        ...
        buttons.register_buttons([
            switch_pin], self._button_handler)
